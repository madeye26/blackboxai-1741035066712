...
// Initialize time tracking records in global state
appState.timeRecords = appState.timeRecords || [];

let employeeSelect, dateInput, timeInInput, timeOutInput, notesInput;
...
function initializeFormInputs() {
    employeeSelect = document.getElementById('time-tracking-employee-select');
    dateInput = document.getElementById('time-tracking-date');
    timeInInput = document.getElementById('time-in');
    timeOutInput = document.getElementById('time-out');
    notesInput = document.getElementById('time-tracking-notes');
}

// Clear form
function clearTimeTrackingForm() {
    if (employeeSelect) {
